...
void D_PolysetDraw(void) {
  ...
  a_spans = (spanpackage_t *)(((int32_t)&spans[0] + CACHE_SIZE - 1) &
                              ~(CACHE_SIZE - 1));
...
void D_PolysetCalcGradients(int32_t skinwidth) {
  ...
  t1 = r_p1[4] - r_p2[4];
  r_lstepx =
      (int32_t)ceil((t1 * p01_minus_p21 - t0 * p11_minus_p21) * xstepdenominv);
  r_lstepy =
      (int32_t)ceil((t1 * p00_minus_p20 - t0 * p10_minus_p20) * ystepdenominv);

  t0 = r_p0[2] - r_p2[2];
  t1 = r_p1[2] - r_p2[2];
  r_sstepx =
      (int32_t)((t1 * p01_minus_p21 - t0 * p11_minus_p21) * xstepdenominv);
  r_sstepy =
      (int32_t)((t1 * p00_minus_p20 - t0 * p10_minus_p20) * ystepdenominv);
