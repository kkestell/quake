...
void D_PolysetRecursiveTriangle (int32_t *p1, int32_t *p2, int32_t *p3);
void D_PolysetSetEdgeTable (void);
void D_RasterizeAliasPolySmooth (void);
void D_PolysetScanLeftEdge (int32_t height);
...
================
*/
void D_PolysetRecursiveTriangle (int32_t *lp1, int32_t *lp2, int32_t *lp3)
{
	int32_t		*temp;
	int32_t		d;
	int32_t		new[6];
...
// very visible, overflow is very unlikely, because of ambient lighting
	...
	t0 = r_p0[2] - r_p2[2];
	t1 = r_p1[2] - r_p2[2];
	r_sstepx = (int32_t)((t1 * p01_minus_p21 - t0 * p11_minus_p21) *
			xstepdenominv);
	r_sstepy = (int32_t)((t1 * p00_minus_p20 - t0* p10_minus_p20) *
			ystepdenominv);

	t0 = r_p0[3] - r_p2[3];
	t1 = r_p1[3] - r_p2[3];
	r_tstepx = (int32_t)((t1 * p01_minus_p21 - t0 * p11_minus_p21) *
			xstepdenominv);
	r_tstepy = (int32_t)((t1 * p00_minus_p20 - t0 * p10_minus_p20) *
			ystepdenominv);

	t0 = r_p0[5] - r_p2[5];
	t1 = r_p1[5] - r_p2[5];
	r_zistepx = (int32_t)((t1 * p01_minus_p21 - t0 * p11_minus_p21) *
			xstepdenominv);
	r_zistepy = (int32_t)((t1 * p00_minus_p20 - t0 * p10_minus_p20) *
			ystepdenominv);
...
void D_RasterizeAliasPolySmooth (void)
{
	int32_t				initialleftheight, initialrightheight;
	int32_t				*plefttop, *prighttop, *pleftbottom, *prightbottom;
	int32_t				working_lstepx, originalcount;
...
void D_PolysetRecursiveDrawLine (int32_t *lp1, int32_t *lp2)
{
	int32_t		d;
	int32_t		new[6];
	int32_t 	ofs;
...
void D_PolysetRecursiveTriangle2 (int32_t *lp1, int32_t *lp2, int32_t *lp3)
{
	int32_t		d;
	int32_t		new[4];
