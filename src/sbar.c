...
int32_t hipweapons[4] = {HIT_LASER_CANNON_BIT, HIT_MJOLNIR_BIT, 4,
...
=============
*/
void Sbar_DrawNum(int32_t x, int32_t y, int32_t num, int32_t digits,
                  int32_t color) {
  char str[12];
  char *ptr;
  int32_t l, frame;
...
int32_t Sbar_ColorForMap(int32_t m) { return m < 128 ? m + 8 : m + 8; }
...
==================
*/
void Sbar_IntermissionNumber(int32_t x, int32_t y, int32_t num, int32_t digits,
                             int32_t color) {
  char str[12];
  char *ptr;
  int32_t l, frame;
