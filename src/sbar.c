...
static int32_t sb_updates; // if >= vid.numpages, no update needed
...
static int32_t hipweapons[4] = {HIT_LASER_CANNON_BIT, HIT_MJOLNIR_BIT, 4, HIT_PROXIMITY_GUN_BIT};
...
static int32_t fragsort[MAX_SCOREBOARD];

static char scoreboardtext[MAX_SCOREBOARD][20];
static int32_t scoreboardtop[MAX_SCOREBOARD];
static int32_t scoreboardbottom[MAX_SCOREBOARD];
static int32_t scoreboardcount[MAX_SCOREBOARD];
static int32_t scoreboardlines;
